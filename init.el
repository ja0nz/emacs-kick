...
(use-package eglot
  ...
  ;; PROD mode, truncate events buffer
  ...
  ;; xref-go-back and xref-find-apropos
  :bind (:map
         eglot-mode-map
         ("<leader> l g t" . eglot-find-typeDefinition)
         ("<leader> l g d" . eglot-find-declaration)
         ("<leader> l g i" . eglot-find-implementation)
         ("<leader> l a" . eglot-code-actions)
         ("<leader> l o" . eglot-code-action-organize-imports)
